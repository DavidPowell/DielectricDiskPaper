...
#input_filenames = ["disk-modes-{:02d}.vtp".format(n) for n in range(7)]
#output_filenames = ["disk-modes-{:02d}.png".format(n) for n in range(7)]
...
view.CameraPosition = [3.3,0,2.5]
view.OrientationAxesVisibility = 0
zoom_level = 1.55

#set image size
view.ViewSize = [800, 700] #[width, height] 
